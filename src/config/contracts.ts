...
export const CONTRACT_ADDRESSES: Record<number, { 
  ...
  [SUPPORTED_CHAINS.HARDHAT]: {
    loanChain: "0x5FbDB2315678afecb367f032d93F642f64180aa3",     // LoanChain V1 (deployed)
    loanChainV2: "",   // LoanChainV2 not deployed yet
    loanChainV3: "",   // LoanChainV3 not deployed yet
    tokenSwap: "",    // TokenSwap contract not deployed yet
    mockUSDC: "",     // Mock USDC token not deployed yet
    mockDAI: "",      // Mock DAI token not deployed yet
    mockUSDT: "",     // Mock USDT token not deployed yet
  },
};
